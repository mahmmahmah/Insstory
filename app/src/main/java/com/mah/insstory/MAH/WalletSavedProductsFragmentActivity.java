...
public class WalletSavedProductsFragmentActivity extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.wallet_saved_products_fragment, _container, false);
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		saved = _view.findViewById(R.id.saved);
	...
	public void _TrLang() {
		title.setText("Kaydediler Ürünler");
	}
