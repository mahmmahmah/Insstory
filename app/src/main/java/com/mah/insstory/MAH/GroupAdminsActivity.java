...
public class GroupAdminsActivity extends AppCompatActivity {
	...
	private RecyclerView admin_list;
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.group_admins);
		...
		_gudb_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (!_childValue.get("member_type").toString().equals("member")) {
					...
					admin_list.setAdapter(new Admin_listAdapter(listmap));
				}
			}
	...
	private void initializeLogic() {
		admin_list.setLayoutManager(new LinearLayoutManager(this));
		...
		if (save.getString("theme", "").equals("light")) {
			...
			if (save.getString("theme", "").equals("dark")) {
				if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
					Window w =GroupAdminsActivity.this.getWindow();
	...
	public void _TrLang() {
		title.setText("Yöneticiler");
	}
	
	
	public void _EnLang() {
		title.setText("Admins");
	}
	...
	public class Admin_listAdapter extends RecyclerView.Adapter<Admin_listAdapter.ViewHolder> {
		
		ArrayList<HashMap<String, Object>> _data;
		
		public Admin_listAdapter(ArrayList<HashMap<String, Object>> _arr) {
			_data = _arr;
		}
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			if (_data.get((int)_position).containsKey("member_username")) {
				yourname.setText(_data.get((int)_position).get("member_type").toString());
			}
			if (_data.get((int)_position).containsKey("member_type")) {
