...
public class NoConnectionActivity extends AppCompatActivity {
				...
				if (SketchwareUtil.isConnected(getApplicationContext())) {
					if ((FirebaseAuth.getInstance().getCurrentUser() != null)) {
						if (getIntent().getStringExtra("BlockedB").equals("true")) {
							i.setClass(getApplicationContext(), BlockActivity.class);
							startActivity(i);
						}
						else {
						...
						i.setClass(getApplicationContext(), ChooselogintypeActivity.class);
						startActivity(i);
					}
				}
				else {
					SketchwareUtil.showMessage(getApplicationContext(), no_internet);
				}
			}
		});
	...
	private void initializeLogic() {
		_rippleRoundStroke(try_again, "#651FFF", "#673AB7", 6, 0, "#FFFFFF");
		_rippleRoundStroke(exit, "#FFFFFF", "#CFD8DC", 6, 2, "#CFD8DC");
	}
	...
	public void _TrLang() {
		title.setText("İnternet bağlantısı yok! Lütfen İnternete bağlı olduğunuz'dan emin olun ve tekrar deneyin.");
		try_again.setText("Tekrar Dene");
		exit.setText("Uygulamayı Kapat");
		no_internet = "İnternet Bağlantısı Yok";
	}
	
	
	public void _EnLang() {
		title.setText("No Internet connection! Please make sure you are connected to the Internet and try again.");
		try_again.setText("Try Again");
		exit.setText("Close App");
	...
	public void _InLang() {
		title.setText("Tidak ada koneksi internet! Pastikan Anda terhubung ke Internet dan coba lagi.");
		try_again.setText("Coba Lagi");
