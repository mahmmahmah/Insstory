...
public class WalletHistoryFragmentActivity extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater _inflater, @Nullable ViewGroup _container, @Nullable Bundle _savedInstanceState) {
		View _view = _inflater.inflate(R.layout.wallet_history_fragment, _container, false);
	...
	private void initialize(Bundle _savedInstanceState, View _view) {
		...
		history = _view.findViewById(R.id.history);
	...
	public void _TrLang() {
		title.setText("Harcama Geçmişi");
	}
	
	
	public void _EnLang() {
		title.setText("Spending History");
	}
